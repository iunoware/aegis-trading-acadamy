...
export default function AdminSettingsPage() {
  ...
  function openEditModal(user: ComplimentaryUser) {
    ...
    setEditForm({
      ...
      discordName: user.discordName,
      status: user.status,
      // Always starts blank — we never fetch or prefill the real password.
      // Leaving this blank on submit means "don't change the password".
      password: "",
    });
              ...
              <div className="min-h-0 flex-1 overflow-y-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-gray-400">
                <div className="grid grid-cols-1 gap-5 p-5 sm:grid-cols-2 sm:p-6">
                  ...
                  <FormField
                    ...
                    description="Determines how long complimentary access lasts."
                  >
                    <select
                      value={newUserForm.planType}
                      onChange={(event) =>
                        updateNewUserField("planType", event.target.value as PlanType)
                      }
                      className={inputClassName}
                    >
                      ...
                      <option value="YEARLY" className="bg-[#121212]">
                        Yearly
                      </option>
                    </select>
                  </FormField>
            ...
            <form onSubmit={handleUpdateUser} className="flex min-h-0 flex-1 flex-col">
              <div className="min-h-0 flex-1 overflow-y-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-gray-400">
                <div className="space-y-5 p-5 sm:p-6">
                  ...
                  <FormField
                    label="New Password"
                    description="Leave blank to keep the student's current password."
                  >
                    <div className="relative">
                      <input
