...
export default function CertificatesPage() {
  ...
  const handleDeleteCertificate = (certificateId: string) => {
    ...
    setConfirmModal({
      ...
      message: `Are you sure you want to permanently delete "${certificate.title}"? This cannot be undone.`,
      onConfirm: async () => {
        setIsDeleting(true);
    ...
    >
      ...
      {confirmModal && (
        <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/80 p-4 backdrop-blur-md">
          <div className="w-full max-w-sm rounded-2xl border border-rose-500/30 bg-[#111113] p-6 shadow-[0_20px_50px_rgba(0,0,0,0.9)]">
            <div>
              <h3 className="mb-2 text-lg font-bold text-white font-sans">
                {confirmModal.title}
              </h3>
            ...
            <div className="mt-5 flex items-center justify-end gap-3 pt-2">
              <button
                ...
                disabled={isDeleting}
                className="cursor-pointer rounded-xl border border-white/15 px-4 py-2 text-xs font-semibold text-zinc-300 hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
              >
                Cancel
              </button>
              <button
                ...
                disabled={isDeleting}
                className="inline-flex cursor-pointer items-center gap-2 rounded-xl bg-rose-500 px-5 py-2 text-xs font-bold text-white shadow-md transition-colors hover:bg-rose-600 disabled:cursor-not-allowed disabled:opacity-60"
              >
